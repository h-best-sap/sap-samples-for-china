sap.ui.define(["sap/ui/core/ResizeHandler"], function (ResizeHandler) {
  "use strict";
  ...
  return {
    ...
    _createOverlay: function (oGridControl) {
      ...
      var oGridDomRef = this._findGridWithinElement(
        oInstance.oGridControl.getDomRef()
      );
      ...
      oInstance.sResizeHandlerId = ResizeHandler.register(
        oInstance.oGridControl,
    ...
    _cloneGridStyle: function (oOverlay, oGridDomRef, mAdditionalStyle) {
      var mGridStyle = window.getComputedStyle(
        this._findGridWithinElement(oGridDomRef)
      );
      var mOverlayStyle = {
      ...
      oOverlay.className =
        oGridDomRef.className + " sapSampleRevealGridOverlay";
    },
