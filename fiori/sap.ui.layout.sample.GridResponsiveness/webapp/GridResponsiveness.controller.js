sap.ui.define(
  ...
  function (Controller, RevealGrid) {
    ...
    return Controller.extend(
      "sap.ui.layout.sample.GridResponsiveness.GridResponsiveness",
      {
        onExit: function () {
        ...
        onAfterRendering: function () {
          var sLayout = this.byId("grid1")
            .getCustomLayout()
            .getActiveGridSettings().sParentAggregationName;
          if (sLayout == "layout") {
